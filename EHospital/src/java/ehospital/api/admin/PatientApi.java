 ...
 * @author admin
 */
@WebServlet(name="PatientApi", urlPatterns={"/patient-api"})
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pathInfo == null || pathInfo.equals("/")) {
                // Get all patients
                List<User> patients = userDAO.getAllByRoleID(3);
                for (User patient : patients) {
                    patient.setPatientFunc();
                }
                JsonObject responseObj = new JsonObject();
                responseObj.addProperty("success", true);
                responseObj.addProperty("message", "Patients retrieved successfully");
                responseObj.add("data", gson.toJsonTree(patients));
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pathInfo == null || pathInfo.equals("/")) {
                ...
                user.getPatient().setUserId(genId);
                user.getPatient().setPatientCode("PTN"+new Date().getTime());
                patientDAO.insert(user.getPatient());

                JsonObject responseObj = new JsonObject();
                responseObj.addProperty("success", true);
                responseObj.addProperty("message", "Patient added successfully");
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pathInfo == null || pathInfo.equals("/")) {
                ...
                patientDAO.update(user.getPatient());
