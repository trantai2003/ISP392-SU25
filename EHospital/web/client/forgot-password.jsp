...
<html>
    <head>
        ...
        <title>Forgot Password - E-Hospital</title>
        <style>
            .forgot-container {
                max-width: 500px;
                margin: 50px auto;
        ...
        <section id="appointment" data-stellar-background-ratio="3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 forgot-container" style="padding: 20px;">
                        <div>
                            <!-- FORGOT PASSWORD FORM HERE -->
                            <form id="forgot-form" role="form" method="post" action="forgot-password">
                                <!-- SECTION TITLE -->
