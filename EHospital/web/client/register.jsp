        ...
        <section id="appointment" data-stellar-background-ratio="3">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 register-container" style="padding: 20px;">
                        <div>
                            <!-- REGISTER FORM HERE -->
                            <form id="register-form" role="form" method="post" action="register">
                                <!-- SECTION TITLE -->
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="text-center">
                                            <a href="login" class="section-btn">
                                                <i class="fa fa-sign-in"></i> Already have an account? Login here
                                            </a>
                                        </div>
                                    </div>
                                </div>
